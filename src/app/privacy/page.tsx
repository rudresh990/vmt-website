...
export const metadata: Metadata = {
  title: "Privacy Notice | Void Matrix Technology",
  description:
    "Learn how Void Matrix Technology collects, uses, and protects your information.",
};
  ...
  return (
    <LegalLayout title="Privacy Notice">
      ...
      <p>
        ...
        email address, phone number, and project details submitted through our
        contact or estimator forms.
      </p>
