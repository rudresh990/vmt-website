...
export default function success() {
    return (
        <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from green-50 to white px-6">
            <div className="p-10 max-w-xl text-center">
                ...
                <p className="mb-8">
                    Thank you for contacting Void Matrix Technology.<br />
                    Our team will review your message and respond within 24 hours.
                </p>
                <div className="mb-4">
                    <p className="mb-2">
                        Follow us on LinkedIn for technology insights, product updates, and structured engineering case studies.
                    </p>
                    <a
    ...
    3.6 4.59v5.603z"/>
                ...
                <Link href="/" className="inline-block text-[var(--text-body)]">Back to Home</Link>
            </div>
        </section>
    )
}