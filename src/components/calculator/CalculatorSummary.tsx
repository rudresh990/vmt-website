    ...
    return (
      <div className="calc-summary" ref={ref} tabIndex={-1}>
        ...
        <p className="calc-disclaimer">
          This estimate is based on high-level inputs and is intended to provide directional
          guidance only. Final pricing may vary after detailed requirement analysis and scope
          definition.
        </p>
